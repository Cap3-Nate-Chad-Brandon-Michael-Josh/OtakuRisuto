...
export default class Suggestions extends Component {
  ...
  componentDidMount() {
    KitsuApiService.getAnimeSuggestions().then((res) => {
      this.setState({
          ...
          {this.state.hoverIndex === index && (
            ...
            >
              ...
              <div className="animeDescription">
                <span className="animeDescriptionTitle">{anime.title}</span>
                <br></br>
                <br></br>
                <span className="animeDescriptionRating">{`Rating: ${anime.rating}`}</span>
                <br></br>
                <span className="animeDescriptionCount">{`Episode Count: ${anime.episode_count}`}</span>
                <br></br>
      ...
      <form className="suggestionsListForm" onSubmit={this.handleSubmitForm}>
        {this.state.seggestions !== [] && (
          <div className="wrapper">
            ...
            <div></div>
            <div className="container">{this.renderSuggestionsItem()}</div>
          </div>
        )}
